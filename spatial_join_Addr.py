...
"""Spatially Joins each tree to the parcel it is located in."""
...
for x in ftc:
    ...
    arcpy.SpatialJoin_analysis(x, addr, joinOut,
                               ...
                               """WOR_7_102_A,Species,-1,-1;DBH "DBH" true true false 4 Long 0 0 ,First,#,E:/Data Collection/"""
                               """ProcessedSurvey/SurveyTrees.gdb/WOR_7_102_A,DBH,-1,-1;Survey_Date "Survey_Date" true true false 8 Date 0 0 ,First,"""
                               """#,E:/Data Collection/ProcessedSurvey/SurveyTrees.gdb/WOR_7_102_A,Survey_Date,-1,-1;ALB_Area """
                               """"ALB_Area" true true false 12 Text 0 0 ,First,#,E:/Data Collection/ProcessedSurvey/"""
                               """SurveyTrees.gdb/WOR_7_102_A,ALB_Area,-1,-1;ALB_Zone "ALB_Zone" true true false 5 Text 0 0 ,First,#,E:/"""
                               """Data Collection/ProcessedSurvey/SurveyTrees.gdb/WOR_7_102_A,ALB_Zone,-1,-1;ALB_Unit "ALB_Unit" true true false 5 Text 0 0 ,First,"""
                               """#,E:/Data Collection/ProcessedSurvey/SurveyTrees.gdb/WOR_7_102_A,ALB_Unit,-1,-1;"""
                               """A_Z_U "A_Z_U" true true false 20 Text 0 0 ,First,#,E:/Data Collection/ProcessedSurvey/SurveyTrees.gdb/"""
                               """WOR_7_102_A,A_Z_U,-1,-1;LOC_ID "LOC_ID" true false false 18 Text 0 0 ,First,#,E:/Data Collection/"""
